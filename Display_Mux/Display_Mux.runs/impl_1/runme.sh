...
HD_PWD='C:/Users/tuamy/Documents/GitHub/willWork/willWork.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_mux.tcl -notrace
