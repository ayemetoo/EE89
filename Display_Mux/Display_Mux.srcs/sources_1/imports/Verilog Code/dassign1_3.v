...
module display_mux (letter, g,f,e,d,c,b,a);
  ...
  //mux8_to_1 driverA_layer1_1(8'b00000010,letter[4:2],outA[0]);
  //mux8_to_1 driverA_layer1_2(8'b10000101,letter[4:2],outA[1]);
  //mux8_to_1 driverA_layer1_3(8'b10010000,letter[4:2],outA[2]);
  //mux8_to_1 driverA_layer1_4(8'b01110001,letter[4:2],outA[3]);
  
  //mux4_to_1 driverA_layer2_1(outA,letter[1:0],A);
  
  //wire [3:0] outG;
  
  //mux8_to_1 driverG_layer1_1(8'b11111111,letter[4:2],outG[0]);
  //mux8_to_1 driverG_layer1_2(8'b10001111,letter[4:2],outG[1]);
  //mux8_to_1 driverG_layer1_3(8'b11100100,letter[4:2],outG[2]);
  //mux8_to_1 driverG_layer1_4(8'b11111111,letter[4:2],outG[3]);
