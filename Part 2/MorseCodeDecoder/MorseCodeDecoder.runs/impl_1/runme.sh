...
HD_PWD='C:/Users/tuamy/Documents/GitHub/EE89/Part 2/MorseCodeDecoder/MorseCodeDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_decoder.tcl -notrace
