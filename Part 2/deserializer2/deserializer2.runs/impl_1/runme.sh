...
HD_PWD='C:/Users/tuamy/Documents/GitHub/EE89/Part 2/deserializer2/deserializer2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_deserializer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_deserializer.tcl -notrace
