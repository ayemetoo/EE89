...
HD_PWD='C:/Users/tuamy/Documents/GitHub/EE89/Part 2/deserializer2/deserializer2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_deserializer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_deserializer.tcl
