...
HD_PWD='C:/Users/tuamy/Documents/GitHub/willWork/willWork.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_mux.tcl
